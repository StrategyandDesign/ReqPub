...
insert into field_rows (project_id, field_id, k, data, pos, updated_by_name, updated_at) values
  ...
  ('prd-reqpub-platform', 'nfr', 4, '{"stmt":"Every change ships with regression tests and the suite stays green (90 unit, 215 backend checks).","fit":"CI runs both suites on every push. Test.","pri":"Must","comp":"Relational core"}'::jsonb, 4, 'Seed', now()),
