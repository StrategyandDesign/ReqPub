/* ReqPub shared site script — footer injection + cookie consent + Do Not Share.
   Cross-site links are ABSOLUTE so this one identical file works on BOTH
   reqpub.com (marketing) and app.reqpub.com (the app). */
(function(){
  ...
  var footerHTML =
    '<footer class="site-foot">'+
      '<div class="wrap">'+
        '<div class="top">'+
          '<div class="col">'+
            '<a class="lockup on-dark" href="https://reqpub.com/" style="font-size:20px">'+
          ...
          '<div class="col"><h5>Product</h5>'+
            '<a href="https://reqpub.com/">Overview</a>'+
            '<a href="https://app.reqpub.com/">Open the app</a>'+
            '<a href="https://app.reqpub.com/signup.html">Sign up</a>'+
            '<a href="https://app.reqpub.com/">Sign in</a>'+
          '</div>'+
          '<div class="col"><h5>Legal</h5>'+
            '<a href="https://reqpub.com/terms.html">Terms of Service</a>'+
            '<a href="https://reqpub.com/privacy.html">Privacy Statement</a>'+
            '<a href="https://reqpub.com/cookies.html">Cookie Policy</a>'+
            '<a href="https://reqpub.com/acceptable-use.html">Acceptable Use</a>'+
          '</div>'+
          '<div class="col"><h5>Company</h5>'+
            '<a href="mailto:[hello@reqpub.example]">Contact</a>'+
            '<a href="https://reqpub.com/do-not-share.html">Your privacy choices</a>'+
        ...
        '<div class="bottom">'+
          ...
          '<div class="legal-links">'+
            '<a href="https://reqpub.com/terms.html">TERMS</a>'+
            '<a href="https://reqpub.com/privacy.html">PRIVACY</a>'+
            '<button type="button" data-rp-cookies>MANAGE COOKIES</button>'+
            '<a href="https://reqpub.com/do-not-share.html">DO NOT SHARE MY PERSONAL INFORMATION</a>'+
          '</div>'+
        '</div>'+
      '</div>'+
    '</footer>';
  ...
  var bannerHTML =
    '<div id="rp-cookie-banner" role="dialog" aria-label="Cookie consent">'+
      '<p>ReqPub uses required cookies to run the service and, with your consent, analytics cookies to understand usage. See our <a href="https://reqpub.com/cookies.html">Cookie Policy</a>.</p>'+
      '<div class="row">'+
  ...
  var modalHTML =
    '<div class="rp-modal-back" id="rp-cookie-modal" role="dialog" aria-modal="true" aria-label="Manage cookie preferences">'+
      '<div class="rp-modal">'+
        ...
        '<p class="desc">Cookies are small files stored on your device. You can turn off optional categories below. See the full <a href="https://reqpub.com/cookies.html">Cookie Policy</a>.</p>'+
        '<div class="rp-pref">'+
  ...
  function save(analytics){
    ...
    // Place to (de)activate analytics scripts based on `analytics`.
  }
