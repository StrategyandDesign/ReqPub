...
export const reqpub = {
  ...
  rows: {
    ...
    metrics: [
      ...
      { metric: 'Backend regression suite', target: '231 checks green on every change', method: 'Embedded-Postgres end-to-end run in CI.' },
    ...
    nfr: [
      ...
      { stmt: 'Every change ships with regression tests and the suite stays green (143 unit, 231 backend checks).', fit: 'CI runs both suites on every push. Test.', pri: 'Must', comp: 'Relational core' },
